...
public class JQAMavenPluginRunner {
	...
	private static void doAsserts(CheckingResult result) {
		...
		// Naming asserts
		assertContains(result, "BO API naming", "ar.com.fluxit.jqa.test.bo.BOForTrucks", fails);
		assertContains(result, "BO API naming", "ar.com.fluxit.jqa.test.bos.TrainBO", fails);
		assertContains(result, "BO API naming", "ar.com.fluxit.jqa.test.bo.impl.BusBO", fails);
		...
		assertContains(result, "DAO API naming", "ar.com.fluxit.jqa.test.dao.DAOForTrucks", fails);
		assertContains(result, "DAO API naming", "ar.com.fluxit.jqa.test.daos.TrainDAO", fails);
		assertContains(result, "DAO API naming", "ar.com.fluxit.jqa.test.dao.impl.BusDAO", fails);
		...
		assertContains(result, "Service API naming", "ar.com.fluxit.jqa.test.service.ServiceForTrucks", fails);
		assertContains(result, "Service API naming", "ar.com.fluxit.jqa.test.services.TrainService", fails);
		assertContains(result, "Service API naming", "ar.com.fluxit.jqa.test.service.impl.BusService", fails);
		...
		// Typing asserts
		assertContains(result, "BO API typing", "ar.com.fluxit.jqa.test.bo.CarBO", fails);
		...
		assertContains(result, "DAO API typing", "ar.com.fluxit.jqa.test.dao.CarDAO", fails);
		...
		assertContains(result, "Service API typing", "ar.com.fluxit.jqa.test.service.CarService", fails);
		...
		// Usages asserts
		assertContains(result, "Service API usages", "ar.com.fluxit.jqa.test.service.CarService", fails);
		assertContains(result, "Service API usages", "ar.com.fluxit.jqa.test.service.BoatService", fails);
		...
		assertContains(result, "BO API usages", "ar.com.fluxit.jqa.test.bo.CarBO", fails);
		assertContains(result, "BO API usages", "ar.com.fluxit.jqa.test.bo.BoatBO", fails);
		...
		assertContains(result, "DAO API usages", "ar.com.fluxit.jqa.test.dao.CarDAO", fails);
