...
public class NamingRuleTest extends TestCase {
	...
	public final void testCheck() {
		...
		testMatches(new NamingRule("a.b"), new String[] { "a.b", "a$b" },
				new String[] { "" });
	}

	private void testMatches(NamingRule rule, String[] positive,
			String[] negative) {
