 ...
 */
public class TruePredicateImpl extends ar.com.fluxit.jqa.schema.ruleset.impl.PredicateImpl implements ar.com.fluxit.jqa.schema.ruleset.TruePredicate {
	private static final long serialVersionUID = 1L;

	public TruePredicateImpl(org.apache.xmlbeans.SchemaType sType) {
		super(sType);
	}
